...
const data = async ()=>{
    ...
    document.querySelector(".gitLink").setAttribute('href',`${newData.github}`);
    document.querySelector(".linkedIn").setAttribute('href',`${newData.linkedIn}`);
    document.querySelector(".summary").innerHTML=newData.summary;
    document.querySelectorAll(".skills__name").forEach((e,key)=>e.innerHTML=newData.techSkills[key]);
};  
